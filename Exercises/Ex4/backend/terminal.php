...
<body>
    ...
    <div class="item box" id="firstResponse">
        ...
        <div class="typewriter wrapper par3 hidden">
            <h1>
                <div style="width:250px;height:0;"><iframe src="https://giphy.com/embed/MDJ9IbxxvDUQM" width="250px" height="150px" style="position:absolute; top:40vh;" frameBorder="0" class="giphy-embed" ></iframe></div>
            </h1>
        </div>
